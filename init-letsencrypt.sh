...
-domains=("buyingnewsoul.me" "www.buyingnewsoul.me")
+domains=(buyingnewsoul.me www.buyingnewsoul.me)
rsa_key_size=4096
-data_path="./data/certbot"
+data_path="./data/certbot"
-email="jasilvamc@uc.cl" # Adding a valid address is strongly recommended
+email="admin@example.com" # Adding a valid address is strongly recommended
staging=1 # Set to 1 when testing setup to avoid hitting request limits
